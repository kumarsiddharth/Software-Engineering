...
class MainsClass
{
	private static int numberContainer[]=new int[1000];
	static int linearSearch(int n,int elementToSearch)/*returns position in the array if found, otherwise, return -1*/
	{
		for(int i=0;i<n;i++)
		{
	...
	public static void main(String args[])throws IOException,Exception
	{
		...
		int result=linearSearch(n,elementToSearch);
		if(result==-1)
		{
